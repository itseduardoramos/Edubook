  ...
  return (
    <div className="row bg-dark text-light">
      ...
      <div className="navbar-brand">
        <img src={logo} className="navbar-brand ms-3" width="3%" alt=""/>
        Edubook
      </div>
            ...
            <div className="d-flex gap-2">
                ...
                <NavLink className="btn btn-dark mr-2" to="/mensajes">
                ...
                <a className="btn btn-dark mr-2" onClick={() => Salir()}>
