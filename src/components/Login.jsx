        ...
        <div className="col-md-4 mt-5 border shadow-lg p-3 mb-5 bg-white rounded">
            ...
            <div className="d-grid gap-2">
                <button className="btn btn-success btn-lg btn-block" type="submit">
                    <a href="https://github.com/itseduardoramos" className="text-decoration-none text-white">
                ...
                <button className="btn btn-primary btn-lg btn-block" type="submit">
                    <a href="https://linkedin.com/in/eduardo-misael-ramos-603528200/" className="text-decoration-none text-white">
